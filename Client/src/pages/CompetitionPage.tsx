...
import CompetitionTabs, { type TabType } from '../components/CompetitionTabs';
...
import type { Competition, Match, Standings } from '../types';
...
const CompetitionPage: React.FC = () => {
  ...
  // Fetch matches
  const { data: matchesData, error: matchesError } = useApi<Match[]>(API_ENDPOINTS.COMPETITION_MATCHES(id!));
