...
const DISABLED_COMPETITION_CODES = ['WC', 'EC', 'CAF', 'AFC', 'CONMEBOL', 'CONCACAF', 'CLI'];
const DISABLED_NAME_PATTERNS = [
  'World Cup',
 ...
 */
const useCompetitionFormat = (standings, matches = [], competition) => {
