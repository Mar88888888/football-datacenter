...
import type { StandingGroup, TableEntry, TeamMinimal } from '../types';
...
interface LeaguePhaseTableProps {
  table: TableEntry[];
  isNationalTeam: boolean;
}

const LeaguePhaseTable: React.FC<LeaguePhaseTableProps> = ({ table, isNationalTeam }) => {
  return (
...
const GroupStage: React.FC<GroupStageProps> = ({ standings, isNationalTeam = false }) => {
